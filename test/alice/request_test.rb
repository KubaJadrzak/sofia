...
module Alice
  class RequestTest < Minitest::Test
    def base_url
      Alice::Types::BaseUrl.new('https://api.example.com')
    end

    # INITILIZATION

    def test_initializes_with_http_method_and_base_url
      request = Alice::Request.new(
        http_method: :get,
        base_url:    base_url,
      )
    ...
    def test_allows_multiple_params_via_mutation
      request = Alice::Request.new(http_method: :get, base_url: base_url)
    ...
    def test_sets_body
      ...
      assert_equal({ 'name' => 'Alice' }, request.body.to_h)
    end

    def test_allows_complex_body_structure
      request = Alice::Request.new(http_method: :post, base_url: base_url)
