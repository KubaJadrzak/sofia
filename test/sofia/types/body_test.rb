    ...
    class BodyTest < Minitest::Test
      ...
      def test_raises_when_body_is_not_a_hash
        error = assert_raises(Sofia::Error::ArgumentError) do
          Sofia::Types::Body.new('not a hash')
        end
