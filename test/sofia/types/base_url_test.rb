...
module Sofia
  module Types
    class SofiaTypesBaseUrlTest < Minitest::Test

      def test_returns_same_url_when_https
        url = 'https://example.com'
        base_url = Sofia::Types::BaseUrl.new(url)
