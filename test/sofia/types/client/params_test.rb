    ...
    module Client
      class ParamsTest < Minitest::Test
        ...
        def test_accepts_flat_hash
          ...
          params = Sofia::Types::Client::Params.new(input)
        ...
        def test_reads_existing_param
          params = Sofia::Types::Client::Params.new('foo' => 'bar')
        ...
        def test_raises_when_params_is_not_a_hash
          error = assert_raises(Sofia::Error::ArgumentError) do
            Sofia::Types::Client::Params.new('not a hash')
          end
        ...
        def test_raises_when_param_value_is_array
          input = { list: [1, 2] }
          error = assert_raises(Sofia::Error::ArgumentError) do
            Sofia::Types::Client::Params.new(input)
          end
