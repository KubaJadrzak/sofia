  ...
  module Types
    class SofiaTypesParamsTest < Minitest::Test
      ...
      def test_accepts_flat_hash
        ...
        params = Sofia::Types::Params.new(input)
      ...
      def test_reads_existing_param
        params = Sofia::Types::Params.new('foo' => 'bar')
      ...
      def test_raises_when_params_is_not_a_hash
        error = assert_raises(Sofia::Error::ArgumentError) do
          Sofia::Types::Params.new('not a hash')
        end
